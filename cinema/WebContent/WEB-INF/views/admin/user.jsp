...
<body style="height: 100%;overflow-y: hidden;">
    <div class="row h-100">
        ...
        <div class="col col-md-9" style="display: flex;flex-direction: column;justify-content: center;align-items: center;">
            <form:form action="${pageContext.request.contextPath}/${actionForm}" method="POST" modelAttribute="CUser" style="padding: 8px;width: 70%;">
            	...
            	<div class="row">
            		<div class="col-md-4">
            			<div class="form-group">
		                	...
		                	<form:input class="form-control" type="date" id="name"  path="firstName"/>		                	
		                	<form:errors path="firstName" cssStyle="color: #E81505"/>
	                	</div>	                	
	                	
            		</div>	
            		<div class="col-md-4">
            			<div class="form-group"><label for="capacity">Pais</label>
		                	<form:input class="form-control" type="text" id="lastName" path="lastName"/>
		                	<form:errors path="lastName" cssStyle="color: #E81505"/>
	               		 </div>
            		</div>	
            		<div class="col-md-4">
            			<div class="form-group"><label for="capacity">Municipio</label>
		                	<form:input class="form-control" type="text" id="lastName" path="lastName"/>
		                	<form:errors path="lastName" cssStyle="color: #E81505"/>
	               		 </div>
            		</div>
